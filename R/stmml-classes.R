...
setClass('stmml:dimension', slots = c('name' = 'xml_attribute', 'power' = 'xml_attribute'), contains = c('eml-2.1.1', 'character')) ## A
setClass('stmml:unitList', slots = c('href' = 'xml_attribute', 'unit' = 'ListOfunit'), contains = c('eml-2.1.1', 'character')) ## A
setClass('stmml:unitType', slots = c('id' = 'xml_attribute', 'name' = 'xml_attribute'), contains = c('eml-2.1.1', 'character')) ## A
setClass('stmml:unit', slots = c('id' = 'xml_attribute', 'abbreviation' = 'xml_attribute', 'name' = 'xml_attribute', 'parentSI' = 'xml_attribute', 'unitType' = 'xml_attribute', 'multiplierToSI' = 'xml_attribute', 'constantToSI' = 'xml_attribute'), contains = c('eml-2.1.1', 'character')) ## A
